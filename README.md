...
### 一键脚本：
```
bash <(wget -qO- https://raw.githubusercontent.com/bioant12/sing-box-yg/refs/heads/main/sb.sh))
```
或者
```
bash <(curl -Ls https://raw.githubusercontent.com/bioant12/sing-box-yg/refs/heads/main/sb.sh)
```
-----------------------------------
